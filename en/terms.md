...
These Terms set out the conditions for using the mobile application "ALM4GEST" (the "App"), provided by Takahiro Kawaguchi (@ekarunian, the "Operator").

By using the App, you are deemed to have agreed to these Terms.

## 2. Nature of the App (unofficial)
...
1. The sync feature works by having you log in to e-amusement yourself in the App's in-app browser, and then retrieving your own publicly available play data.
2. The App does not collect, store, or transmit the ID, password, or other credentials used to log in.
3. Please follow KONAMI's terms when using e-amusement.
4. Changes on the e-amusement side may make the sync feature unavailable.

## 4. Prohibited conduct

You must not:

1. Decompile or modify the App in a way that places excessive load on e-amusement or on the App's servers
...
1. The App displays advertisements to cover the cost of offering it free of charge.
2. The Operator is not responsible for the content of advertisements or for your dealings with advertisers.
3. The handling of information related to advertising is set out in the Privacy Policy.

## 6. Paid services

1. The core features of the App are free.
2. The App may offer an optional in-app purchase (a tip) intended to support development.
3. A tip is a gratuity for development support, not payment for additional features or services (refunds after purchase follow App Store / Google Play policy).

## 7. Backup feature

1. The App offers a backup feature for carrying your data over when you change devices.
2. A restore code issued by the App is required to retrieve backed-up data (please keep your restore code yourself).
